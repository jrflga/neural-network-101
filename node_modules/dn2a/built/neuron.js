...
var Neuron = function Neuron(precisionConfiguration) {
    precisionConfiguration = precisionConfiguration || {
        numbersPrecision: 32
    };
    var Neuron = function Neuron(configuration) {
        ...
        this._transferFunction = function (value) {
            return m.divide(m.bignumber(1), m.sum(m.bignumber(1), m.exp(m.subtract(m.bignumber(0), value))));
        };
    };
    ...
    Neuron.prototype = {
        ...
        addIncomingConnection: function addIncomingConnection(value) {
            this._incomingConnections.push(value);
        },
        addOutgoingConnection: function addOutgoingConnection(value) {
            this._outgoingConnections.push(value);
        },
        addPreviousIncomingConnection: function addPreviousIncomingConnection(value) {
            this._previousIncomingConnections.push(value);
        },
        addPreviousOutgoingConnection: function addPreviousOutgoingConnection(value) {
