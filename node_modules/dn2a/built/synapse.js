...
var Synapse = function Synapse(precisionConfiguration) {
    precisionConfiguration = precisionConfiguration || {
        numbersPrecision: 32
    };
    var Synapse = function Synapse(configuration) {
        ...
        this._weight = m.subtract(m.bignumber(1), m.multiply(m.bignumber(m.format(m.random(0, 1), {
            notation: "fixed",
            precision: 15
        })), m.bignumber(2)));
